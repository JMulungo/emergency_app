...
class CategorizesControllerTest < ActionController::TestCase
  ...
  test "should create categorize" do
    assert_difference('Categorize.count') do
      post :create, categorize: { date: @categorize.date, description: @categorize.description, location: @categorize.location, type: @categorize.type }
    end
  ...
  test "should update categorize" do
    put :update, id: @categorize, categorize: { date: @categorize.date, description: @categorize.description, location: @categorize.location, type: @categorize.type }
    assert_redirected_to categorize_path(assigns(:categorize))
  end
